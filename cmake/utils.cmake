...
# cskel_try_compile_run(RESULT_VAR
#                       OUTPUT_VAR
#                       LITERAL_CODE
#                       EXTENSION)
#
# Try to compile and run 'LITERAL_CODE' as a file with extension 'EXTENSION'
# and assign the result of the execution to the name '$RESULT_VAR' and the
# output to the variable '$OUTPUT_VAR'.
macro(cskel_try_compile_run RESULT_VAR OUTPUT_VAR LITERAL_CODE EXTENSION)
  if (NOT cm__tmp_nam)
    set(cm__tmp_nam 0)
  else()
